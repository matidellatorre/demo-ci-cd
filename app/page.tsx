export default function Home() {
  ...
  const companyDescription = "Transformando el futuro";
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Características</a>
              <a href="#pricing" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Precios</a>
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        <div className="text-center space-y-8">
          <h1 className="text-6xl font-bold text-indigo-600 dark:text-indigo-400 animate-fade-in">
            {companyName}
          </h1>
          <p className="text-2xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto animate-slide-up">
            {companyDescription}
          </p>
          <div className="flex justify-center gap-4">
            ...
            <button className="border-2 border-indigo-600 text-indigo-600 px-8 py-3 rounded-full hover:bg-indigo-50 transition-all transform hover:scale-105">
              Ver Demo
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Optimiza tus procesos con nuestra IA de última generación
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
            <div className="text-indigo-600 text-4xl mb-4">💡</div>
      ...
      <div id="pricing" className="container mx-auto px-4 py-20">
        <div className="bg-indigo-600 rounded-2xl p-12 text-center text-white">
          ...
          <p className="text-xl mb-8">
            Únete a más de 10,000 empresas que ya confían en {companyName}
          </p>
          <button className="bg-white text-indigo-600 px-8 py-3 rounded-full hover:bg-gray-100 transition-all transform hover:scale-105">
            Solicitar Demo
          </button>
        </div>
      </div>
